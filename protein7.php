...
<li><a href="plan.php">PLANS</a></li>
      ...
      <section class="section">
        <div class="text">
            ...
            <br>
            <h2 class="py-4">
                MUSCLE BLAZE TURKESTERONE 
            </h2>
            <br>
            <h3 class="mt-1 mt-1">PRODUCT DETAILS</h3>
         <p>
         Each bottle of Turkesterone extract contains 120 capsules and 500mg of Ajuga Turkestanica Extract Turkesterone per capsule. (500mg servings and 120 servings) Enough Turkesterone to last a full four months 
            <div class="rating">
            ...
            <select class="my-3">
                    ...
                    <button type="submit"  name="submit" placeholder="submit" value="ADD TO CART &#8594" class="btn">ADD TO CART &#8594</button>
                    </form>
                    <!-- <a href="" class="btn">ADD TO CART &#8594;</a> -->
        </div>
        <img src="protein11b.jpg">
</p>
