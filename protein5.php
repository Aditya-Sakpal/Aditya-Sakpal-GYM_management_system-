...
<li><a href="plan.php">PLANS</a></li>
      ...
      <section class="section">
        <div class="text">
            ...
            <br>
            <h2 class="py-4">
                MUSCLE BLAZE BCAA PRO 
            </h2>
            <br>
            <h3 class="mt-1 mt-1">PRODUCT DETAILS</h3>
         <p>
         MuscleBlaze® BCAA Pro provides 7g of BCAAs in each serving which is 100% vegan. BCAAs support muscle growth & recovery and minimize catabolism during your workout
            <div class="rating">
