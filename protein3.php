...
<li><a href="plan.php">PLANS</a></li>
      ...
      <section class="section">
        <div class="text">
            ...
            <br>
            <h2 class="py-4">
                MUSCLE BLAZE CREATINE
            </h2>
            <br>
            <h3 class="mt-1 mt-1">PRODUCT DETAILS</h3>
         <p>
         Creatine Monohydrate provides 3g of unadulterated creatine which is instantly absorbed by the body, providing a constant supply of energy by resynthesizing ADPs into ATPs (the energy currency) of your body.
            <div class="rating">
