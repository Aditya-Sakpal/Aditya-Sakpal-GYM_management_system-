...
<li><a href="plan.php">PLANS</a></li>
      ...
      <section class="section">
        <div class="text">
         ...
         <p>
         ENHANCED ABSORPTION FORMULA (EAF ): MB BiozymeWhey Protein ensures 50% higher protein absorption and 60% superior BCAA absorption compared to other whey proteins.
            <div class="rating">
