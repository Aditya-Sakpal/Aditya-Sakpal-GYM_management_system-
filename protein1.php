...
<li><a href="plan.php">PLANS</a></li>
      ...
      <section class="section">
        <div class="text">
            ...
            <br>
            <h2 class="py-4">
                MUSCLE BLAZE ISOLATE WHEY 
            </h2>
            <br>
            <h3 class="mt-1 mt-1">PRODUCT DETAILS</h3>
         <p>
            Highest Quality, LOW CARB Imported Whey Protein Isolate consisting of Lactose-free protein - now in the award-winning & globally recognized Biozyme formulation!         
            <div class="rating">
            ...
            <select class="my-3" name="pflavour" value="">
                        <option>Select flavour</option>
                        <option>CHOCOLATE</option>
                        <option>MANGO</option>
                        <option>BUTTER SCOTH</option>
                    </select>
                    
                    <input type="number" name="pquantity" value="min='1' max='10' " placeholder="1" class="inp">
                    ...
                    <input type="submit" name="submit" placeholder="submit" value="ADD TO CART &#8594" class="btn">
                    </form>
                </div>
        <img src="protein4b.jpg">
</p>
        ...
        <section class="container sproduct my-5 pt-5">
            <div class="row mt-5">
                <div class="col-lg-5 col-md-12 col-12">
                    <img class="img" src="protein4b.jpg"> 
                    
                </div>
                
                <div class="col-lg-6 col-md-12 col-12">
                    <h6>MUSCLE MANUFACTURER</h6>
                    <h3>MUSCLE BLAZE BIOZYME WHEY ISOLATE</h3>
                    <h2>Rs2000.00</h2>
                    <select class="my-3">
                        <option>Select flavour</option>
                        <option>CHOCOLATE</option>
